...
public class LoggedInActivity extends ActionBarActivity {
	...
	private void updateVersion() {
		...
		UmengUpdateAgent.setAppkey("546eb013fd98c516e60017fa");
	...
	private void init() {
		...
		if (intent.getBooleanExtra(FROM_USER, false)) {
			...
			Integer friendID = (Integer) intent.getSerializableExtra(FRIENDID);
	...
	private void initPersonalActionBar() {
		if (personFragment.isAdded()) {
			personFragment.initActionBar();
		}
	}
