...
public class MethodEntity {
	...
	// 存放重载方法参数
	private ArrayList<Class<?>[]> repeatMethodsParamTypes;
	 ...
	 * @param list
	 */
	public void setRepeatMethodsParamTypes(ArrayList<Class<?>[]> list) {
	 ...
	 * @return
	 */
	public ArrayList<Class<?>[]> getRepeatMethodsParamTypes() {
	...
	public void setRepeatMethodsParamTypes(Class<?>[] paramTypes) {
		if (this.repeatMethodsParamTypes == null)
			this.repeatMethodsParamTypes = new ArrayList<Class<?>[]>();
